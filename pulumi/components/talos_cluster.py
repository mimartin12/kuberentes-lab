...
class TalosCluster(pulumi.ComponentResource):
        ...
        for node_config in args.nodes:
            ...
            node = TalosNode(
                ...
                TalosNodeArgs(
                    ...
                    talos_installer_image=args.talos_installer_image,
                    talos_iso_file_id=args.talos_iso_file_id,
    ...
    def _create_talosconfig(
        ...
        return talosconfig_dict.apply(lambda cfg: yaml.dump(cfg, default_flow_style=False))
